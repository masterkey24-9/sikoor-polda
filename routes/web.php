...
Route::get('/dashboard', function () {
    if (auth()->user()->role === 'admin') {
        ...
        $trafficLightIndikator = function (?float $nilai) use ($kategoriIkpa) {
            ...
            return match ($label) {
                'Sangat Baik', 'Baik' => ['warna' => 'Hijau', 'bar' => 'bg-emerald-500', 'teks' => 'text-emerald-600'],
                'Cukup' => ['warna' => 'Kuning', 'bar' => 'bg-amber-500', 'teks' => 'text-amber-600'],
                'Kurang' => ['warna' => 'Merah', 'bar' => 'bg-red-500', 'teks' => 'text-red-600'],
                default => ['warna' => 'Belum Dinilai', 'bar' => 'bg-slate-200', 'teks' => 'text-slate-400'],
            };
        };
